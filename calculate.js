(() => {
    ...
    function getServiceCatalog() {
        return [
            ...
            { name: 'Одностраничный сайт - лендинг', devHours: 8 },
            { name: 'Многостраничный сайт или корпоративный', devHours: 56 },
            { name: 'Интернет магазин', devHours: 100 },

            // En
            { name: 'Landing page', devHours: 8 },
            { name: 'Corporate website', devHours: 56 },
            { name: 'Online store', devHours: 100 },
